...
public final class FragmentContactBinding implements ViewBinding {
  ...
  private FragmentContactBinding(@NonNull ConstraintLayout rootView,
      @NonNull Button btnDeleteSelected, @NonNull LinearLayout contactsList,
  ...
  public static FragmentContactBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.contactsList;
      LinearLayout contactsList = ViewBindings.findChildViewById(rootView, id);
      ...
      return new FragmentContactBinding((ConstraintLayout) rootView, btnDeleteSelected,
          contactsList, tvTitle);
    }
