...
public final class ActivityProfileViewBinding implements ViewBinding {
  ...
  private ActivityProfileViewBinding(@NonNull LinearLayout rootView,
      @NonNull ImageView ivProfilePicture, @NonNull TextView tvEmail,
      @NonNull TextView tvMobileNumber, @NonNull TextView tvUsername) {
  ...
  public static ActivityProfileViewBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityProfileViewBinding((LinearLayout) rootView, ivProfilePicture, tvEmail,
          tvMobileNumber, tvUsername);
    }
